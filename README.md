...
**7** formats, **165,248** cases settled by walking their whole input space, **11,765** regions of real cartridge data read three ways, **0** failures, **799** tests, **100%** statement and branch coverage, no dependencies
